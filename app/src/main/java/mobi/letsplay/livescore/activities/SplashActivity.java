...
import mobi.letsplay.livescore.network.ParameterFactory;
import mobi.letsplay.livescore.volley.HttpError;
import mobi.letsplay.livescore.volley.HttpGet;
import mobi.letsplay.livescore.volley.HttpListener;
...
public class SplashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(mobi.letsplay.livescore.R.layout.fragment_splash);
        try {
    ...
    private void startAppHandler(){
        ...
        mHandler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                overridePendingTransition(mobi.letsplay.livescore.R.anim.slide_in_left,
                        mobi.letsplay.livescore.R.anim.slide_out_left);
                finish();
            }
        }, 1500);
    }
