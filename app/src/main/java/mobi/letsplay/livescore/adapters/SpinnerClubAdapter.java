...
public class SpinnerClubAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.lblItem = (TextView) convertView.findViewById(mobi.letsplay.livescore.R.id.lbl_item_spinner);
        ...
        if (clubsObj != null) {
            ...
            if (position == 0) {
                holder.lblItem.setTextColor(ContextCompat.getColor(mActivity, mobi.letsplay.livescore.R.color.yellow_dark));
            } else {
                holder.lblItem.setTextColor(ContextCompat.getColor(mActivity, mobi.letsplay.livescore.R.color.black));
            }
        }
