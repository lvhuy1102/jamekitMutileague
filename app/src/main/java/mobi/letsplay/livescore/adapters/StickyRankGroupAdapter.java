...
import mobi.letsplay.livescore.objects.RankGroupObject;
...
public class StickyRankGroupAdapter extends BaseAdapter implements
    ...
    public View getView(final int position, View convertView,
        ...
        if (convertView == null) {
            ...
            convertView = mInflate.inflate(mobi.letsplay.livescore.R.layout.item_rank_clubs, null);

            holder.llRank = (LinearLayout) convertView.findViewById(mobi.letsplay.livescore.R.id.ll_rank_club);
            holder.lblRank = (TextView) convertView.findViewById(mobi.letsplay.livescore.R.id.lbl_rank_clubs);
//            imgLogo = (ImageView) view.findViewById(R.id.img_logoClub);
            holder.lblNameClubs = (TextView) convertView.findViewById(mobi.letsplay.livescore.R.id.lbl_name_clubs);
            holder.lblNameClubs.setSelected(true);
            holder.lblP = (TextView) convertView.findViewById(mobi.letsplay.livescore.R.id.lbl_value_p);
            holder.lblW = (TextView) convertView.findViewById(mobi.letsplay.livescore.R.id.lbl_value_w);
            holder.lblD = (TextView) convertView.findViewById(mobi.letsplay.livescore.R.id.lbl_value_d);
            holder.lblL = (TextView) convertView.findViewById(mobi.letsplay.livescore.R.id.lbl_value_l);
            holder.lblGD = (TextView) convertView.findViewById(mobi.letsplay.livescore.R.id.lbl_value_gd);
            holder.lblPTS = (TextView) convertView.findViewById(mobi.letsplay.livescore.R.id.lbl_value_pts);
