...
import mobi.letsplay.livescore.objects.EventObject;
...
public class EventAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            holder = new Holder();
            convertView = mInflater.inflate(mobi.letsplay.livescore.R.layout.item_events, null);
            holder.imgEventAwayBottom = (ImageView) convertView
                    .findViewById(mobi.letsplay.livescore.R.id.img_event_type_away_bottom);
            holder.imgEventAwayMid = (ImageView) convertView
                    .findViewById(mobi.letsplay.livescore.R.id.img_event_type_away_mid);
            holder.imgEventAwayTop = (ImageView) convertView
                    .findViewById(mobi.letsplay.livescore.R.id.img_event_type_away_top);
            holder.imgEventHomeTop = (ImageView) convertView
                    .findViewById(mobi.letsplay.livescore.R.id.img_event_type_home_top);
            holder.imgEventHomeMid = (ImageView) convertView
                    .findViewById(mobi.letsplay.livescore.R.id.img_event_type_home_mid);
            holder.imgEventHomeBottom = (ImageView) convertView
                    .findViewById(mobi.letsplay.livescore.R.id.img_event_type_home_bottom);

            holder.lblEventAwayBottom = (TextView) convertView
                    .findViewById(mobi.letsplay.livescore.R.id.lbl_event_away_bottom);
            holder.lblEventAwayBottom.setSelected(true);
            holder.lblEventAwayMid = (TextView) convertView
                    .findViewById(mobi.letsplay.livescore.R.id.lbl_event_away_mid);
            holder.lblEventAwayMid.setSelected(true);
            holder.lblEventAwayTop = (TextView) convertView
                    .findViewById(mobi.letsplay.livescore.R.id.lbl_event_away_top);
            holder.lblEventAwayTop.setSelected(true);
            holder.lblEventHomeBottom = (TextView) convertView
                    .findViewById(mobi.letsplay.livescore.R.id.lbl_event_home_bottom);
            holder.lblEventHomeBottom.setSelected(true);
            holder.lblEventHomeMid = (TextView) convertView
                    .findViewById(mobi.letsplay.livescore.R.id.lbl_event_home_mid);
            holder.lblEventHomeMid.setSelected(true);
            holder.lblEventHomeTop = (TextView) convertView
                    .findViewById(mobi.letsplay.livescore.R.id.lbl_event_home_top);
            holder.lblEventHomeTop.setSelected(true);
            holder.lblEventMinute = (TextView) convertView
                    .findViewById(mobi.letsplay.livescore.R.id.lbl_event_minute);

            holder.rlEventHome = (RelativeLayout) convertView
                    .findViewById(mobi.letsplay.livescore.R.id.rl_events_home);
            holder.rlEventAway = (RelativeLayout) convertView
                    .findViewById(mobi.letsplay.livescore.R.id.rl_events_away);
            holder.llImgAway = (LinearLayout) convertView
                    .findViewById(mobi.letsplay.livescore.R.id.ll_img_events_away);
            holder.llImgHome = (LinearLayout) convertView
                    .findViewById(mobi.letsplay.livescore.R.id.ll_img_events_home);

            holder.lblEventScores = (TextView) convertView
                    .findViewById(mobi.letsplay.livescore.R.id.lbl_event_scores);
            holder.lblEmpty = (TextView) convertView
                    .findViewById(mobi.letsplay.livescore.R.id.lbl_empty);
            holder.llEventRow = (LinearLayout) convertView
                    .findViewById(mobi.letsplay.livescore.R.id.ll_event_row);
        ...
        if (mEventObj != null) {
            ...
            if (mEventObj.getmClubId().equals(mMatchObj.getmHome())) {
                ...
                if (mEventObj.getmEventType().equals(
                    ...
                    holder.imgEventHomeMid.setImageResource(mobi.letsplay.livescore.R.drawable.ic_ball);
                    ...
                    holder.imgEventHomeMid
                            .setImageResource(mobi.letsplay.livescore.R.drawable.ic_own_goal);
                    holder.lblEventHomeMid.setText(mEventObj.getmPlayer());
                } else if (mEventObj.getmEventType().equals(
                    ...
                    holder.lblEventHomeMid.setVisibility(View.VISIBLE);
                    holder.imgEventHomeMid
                            .setImageResource(mobi.letsplay.livescore.R.drawable.ic_red_card);
                    holder.lblEventHomeMid.setText(mEventObj.getmPlayer());
                } else if (mEventObj.getmEventType().equals(
                    ...
                    holder.lblEventHomeMid.setVisibility(View.VISIBLE);
                    holder.imgEventHomeMid
                            .setImageResource(mobi.letsplay.livescore.R.drawable.ic_yellow_card);
                    holder.lblEventHomeMid.setText(mEventObj.getmPlayer());
                } else if (mEventObj.getmEventType().equals(
                    ...
                    holder.lblEventHomeMid.setVisibility(View.VISIBLE);
                    holder.imgEventHomeMid
                            .setImageResource(mobi.letsplay.livescore.R.drawable.ic_penalty);
                    holder.lblEventHomeMid.setText(mEventObj.getmPlayer());
                } else if (mEventObj.getmEventType().equals(
                    ...
                    for (int i = 0; i < mArrEvent.size(); i++) {
                        if (mEventObj.getmMinute().equals(
                            ...
                            holder.imgEventHomeTop
                                    .setImageResource(mobi.letsplay.livescore.R.drawable.ic_arrow_up);
                            holder.imgEventHomeBottom
                                    .setVisibility(View.VISIBLE);
                            holder.imgEventHomeBottom
                                    .setImageResource(mobi.letsplay.livescore.R.drawable.ic_arrow_down);
                ...
                if (mEventObj.getmEventType().equals(
                    ...
                    holder.imgEventAwayMid.setImageResource(mobi.letsplay.livescore.R.drawable.ic_ball);
