...
import mobi.letsplay.livescore.Listener.AdapterListener;
...
import mobi.letsplay.livescore.objects.MessageObj;
...
public class MessageAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            view = inflater.inflate(mobi.letsplay.livescore.R.layout.item_chatbox, null);
            holder = new HolderView();
            view.setTag(holder);
        } else {
            holder = (HolderView) view.getTag();
        }
        holder.tvMessage = (TextView) view.findViewById(mobi.letsplay.livescore.R.id.tvMessage);
        holder.tvUserName = (TextView) view.findViewById(mobi.letsplay.livescore.R.id.tvUserName);
        holder.tvDateTime = (TextView) view.findViewById(mobi.letsplay.livescore.R.id.tvDateTime);
        ...
        if (messageObj != null) {
            ...
            if (messageObj.getUserID().equals(FruitySharedPreferences.getInstance(activity).getStringValue(Constants.USERID))) {
                holder.tvUserName.setTextColor(activity.getResources().getColor(mobi.letsplay.livescore.R.color.red));
                holder.tvUserName.setText(messageObj.getUserName());
            } else {
                holder.tvUserName.setText(messageObj.getUserName());
                holder.tvUserName.setTextColor(activity.getResources().getColor(mobi.letsplay.livescore.R.color.black));
            }
        }
