...
public class OddsAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            holder = new Holder();
            convertView = inflater.inflate(mobi.letsplay.livescore.R.layout.item_odd, null);

            holder.lblBookmarker = (TextView) convertView.findViewById(mobi.letsplay.livescore.R.id.lbl_bookmarker);
            holder.lblHome = (TextView) convertView.findViewById(mobi.letsplay.livescore.R.id.lbl_home);
            holder.lblDraw = (TextView) convertView.findViewById(mobi.letsplay.livescore.R.id.lbl_draw);
            holder.lblAway = (TextView) convertView.findViewById(mobi.letsplay.livescore.R.id.lbl_away);
