package mobi.letsplay.livescore.sticky;
...
import mobi.letsplay.livescore.sticky.WrapperViewList.LifeCycleListener;
	...
	public StickyListHeadersListView(Context context, AttributeSet attrs,
		...
		if (attrs != null) {
			TypedArray a = context.getTheme().obtainStyledAttributes(attrs,
					mobi.letsplay.livescore.R.styleable.StickyListHeadersListView, 0, 0);

			try {
				// -- View attributes --
				int padding = a.getDimensionPixelSize(
						mobi.letsplay.livescore.R.styleable.StickyListHeadersListView_android_padding,
						0);
				mPaddingLeft = a
						.getDimensionPixelSize(
								mobi.letsplay.livescore.R.styleable.StickyListHeadersListView_android_paddingLeft,
								padding);
				mPaddingTop = a
						.getDimensionPixelSize(
								mobi.letsplay.livescore.R.styleable.StickyListHeadersListView_android_paddingTop,
								padding);
				mPaddingRight = a
						.getDimensionPixelSize(
								mobi.letsplay.livescore.R.styleable.StickyListHeadersListView_android_paddingRight,
								padding);
				mPaddingBottom = a
						.getDimensionPixelSize(
								mobi.letsplay.livescore.R.styleable.StickyListHeadersListView_android_paddingBottom,
								padding);
				...
				mClippingToPadding = a
						.getBoolean(
								mobi.letsplay.livescore.R.styleable.StickyListHeadersListView_android_clipToPadding,
								true);
				...
				final int scrollBars = a
						.getInt(mobi.letsplay.livescore.R.styleable.StickyListHeadersListView_android_scrollbars,
								0x00000200);
				...
				if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.GINGERBREAD) {
					mList.setOverScrollMode(a
							.getInt(mobi.letsplay.livescore.R.styleable.StickyListHeadersListView_android_overScrollMode,
									0));
				}
				...
				mList.setFadingEdgeLength(a
						.getDimensionPixelSize(
								mobi.letsplay.livescore.R.styleable.StickyListHeadersListView_android_fadingEdgeLength,
								mList.getVerticalFadingEdgeLength()));
				final int fadingEdge = a
						.getInt(mobi.letsplay.livescore.R.styleable.StickyListHeadersListView_android_requiresFadingEdge,
								0);
				...
				mList.setCacheColorHint(a
						.getColor(
								mobi.letsplay.livescore.R.styleable.StickyListHeadersListView_android_cacheColorHint,
								mList.getCacheColorHint()));
				if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
					mList.setChoiceMode(a
							.getInt(mobi.letsplay.livescore.R.styleable.StickyListHeadersListView_android_choiceMode,
									mList.getChoiceMode()));
				}
				mList.setDrawSelectorOnTop(a
						.getBoolean(
								mobi.letsplay.livescore.R.styleable.StickyListHeadersListView_android_drawSelectorOnTop,
								false));
				mList.setFastScrollEnabled(a
						.getBoolean(
								mobi.letsplay.livescore.R.styleable.StickyListHeadersListView_android_fastScrollEnabled,
								mList.isFastScrollEnabled()));
				if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
					mList.setFastScrollAlwaysVisible(a
							.getBoolean(
									mobi.letsplay.livescore.R.styleable.StickyListHeadersListView_android_fastScrollAlwaysVisible,
									mList.isFastScrollAlwaysVisible()));
				}

				mList.setScrollBarStyle(a
						.getInt(mobi.letsplay.livescore.R.styleable.StickyListHeadersListView_android_scrollbarStyle,
								0));

				if (a.hasValue(mobi.letsplay.livescore.R.styleable.StickyListHeadersListView_android_listSelector)) {
					mList.setSelector(a
							.getDrawable(mobi.letsplay.livescore.R.styleable.StickyListHeadersListView_android_listSelector));
				}

				mList.setScrollingCacheEnabled(a
						.getBoolean(
								mobi.letsplay.livescore.R.styleable.StickyListHeadersListView_android_scrollingCache,
								mList.isScrollingCacheEnabled()));

				if (a.hasValue(mobi.letsplay.livescore.R.styleable.StickyListHeadersListView_android_divider)) {
					mDivider = a
							.getDrawable(mobi.letsplay.livescore.R.styleable.StickyListHeadersListView_android_divider);
				}

				mDividerHeight = a
						.getDimensionPixelSize(
								mobi.letsplay.livescore.R.styleable.StickyListHeadersListView_android_dividerHeight,
								mDividerHeight);

				mList.setTranscriptMode(a
						.getInt(mobi.letsplay.livescore.R.styleable.StickyListHeadersListView_android_transcriptMode,
								ListView.TRANSCRIPT_MODE_DISABLED));

				// -- StickyListHeaders attributes --
				mAreHeadersSticky = a.getBoolean(
						mobi.letsplay.livescore.R.styleable.StickyListHeadersListView_hasStickyHeaders,
						true);
				mIsDrawingListUnderStickyHeader = a
						.getBoolean(
								mobi.letsplay.livescore.R.styleable.StickyListHeadersListView_isDrawingListUnderStickyHeader,
								true);
			} finally {
				a.recycle();
			}
